...
const routes: Routes = [
  ...
  { path: 'login', loadChildren: () => import('./auth/auth-description/auth-description.module').then(c => c.AuthDescriptionModule) },
  { path: 'registration', loadChildren: () => import('./auth/auth-description/auth-description.module').then(c => c.AuthDescriptionModule) },
